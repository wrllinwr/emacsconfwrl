...
;; code
;; fxr xref-find-references ;; auto generate tags
;; xref-show-location-at-point
;; list-tags, list all function source file be switched.
;; fci counsel-imenu
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-mode projectile flycheck neotree eproject which-key counsel-etags helm-gtags ubuntu-theme eclipse-theme vscdark-theme vscode-icon vscode-dark-plus-theme basic-theme vegetative-theme timu-caribbean-theme auto-complete window-numbering evil-escape 0blayout undo-tree evil ag ace-window company)))
(custom-set-faces
